...
<section id="hero">
    ...
    <p>Save more with coupons and uptp 70% off!!</p>
...
<section id="feature" class="section-p1">
    <div class="fe-box">
        ...
        <h6 class="bg-danger">Free Shipping!</h6> 
    </div>
    <div class="fe-box">
        <img src="img/features/f2.png" alt="">
        <h6 class="bg-info">Online Order</h6> 
    </div>
    <div class="fe-box">
        <img src="img/features/f3.png" alt="">
        <h6  class="bg-warning">Save Money!</h6> 
    </div>
    <div class="fe-box">
        <img src="img/features/f4.png" alt="">
        <h6 class="bg-success">Promotions</h6> 
    </div>
    <div class="fe-box">
        <img src="img/features/f5.png" alt="">
        <h6 class="bg-danger">Happy Sell</h6> 
    </div>
    <div class="fe-box">
        <img src="img/features/f6.png" alt="">
        <h6 class="bg-warning">Support</h6> 
    </div>
</section>
...
<section id="sm-banner" class="section-p1">
    <div class="banner-box">
        ...
        <span>The best Classic Dress is on sale at AM</span>
